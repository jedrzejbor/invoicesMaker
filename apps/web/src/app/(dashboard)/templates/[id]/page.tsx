    ...
    const loadData = async () => {
      ...
      try {
        const [clientsData, templateData] = await Promise.all([
          ...
          templatesApi.getById(token, templateId),
        ]);
        ...
        reset({
          ...
          paymentDays: templateData.paymentDays,
          issuePlace: templateData.issuePlace,
        ...
        toast({
          variant: 'destructive',
          title: 'Błąd',
          description: 'Nie udało się pobrać danych szablonu',
        });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Edytuj szablon</h1>
          <p className="text-muted-foreground">
            Zaktualizuj szablon cyklicznej faktury
          </p>
        </div>
      </div>
